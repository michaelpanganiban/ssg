...
$(".view-contract").click(function(e){
	...
	html += '<div class="row"><div class="form-group col-md-12"><table class="table"><thead><tr><th class="text-center">Contract</th><th class="text-center">Start Date</th><th class="text-center">Expiry Date</th><th>Remaining Months</th><th>Type</th><th class="text-center">Headcount</th><th class="text-center">Remarks</th><th class="text-center">Attachment</th><th><i class="fa fa-2x fa-plus-circle text-success" style="cursor:pointer;" id="add-annex"></i></th></tr></thead>';
